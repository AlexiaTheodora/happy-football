...
import numpy as np
import pandas as pd
from pyomyo2 import Myo, emg_mode
from pyomyo1 import Myo1, emg_mode1

m = Myo(mode=emg_mode.PREPROCESSED)
m1 = Myo1(mode=emg_mode1.PREPROCESSED)
...
# Vibrate to know we connected okay
	...
	print("Data Worker 1  started to collect")
...
if __name__ == '__main__':
	...
	m = Myo(mode=emg_mode.PREPROCESSED)
	m.connect(addr = 'ec:07:35:d9:7a:c6')
	...
	m1 = Myo1(mode=emg_mode1.PREPROCESSED)
	m1.connect(addr = 'e8:26:3b:f2:38:16')
