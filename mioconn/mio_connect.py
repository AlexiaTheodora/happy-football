...
class MioConnect:
    ...
    def main(argv, self):
        ...
        try:
            ...
            info_emg1 = StreamInfo('EMG_Stream_Left', 'EMG', 8, 1000, 'float32', 'EMG1_ID')
            ...
            info_emg2 = StreamInfo('EMG_Stream_Right', 'EMG', 8, 1000, 'float32', 'EMG2_ID')
            ...
            while True:
                ...
                myo_driver.data_handler.myo_data1.empty()):
                    ...
                    # self.plot(scr, [e / 500. for e in emg1], [e1 / 500. for e1 in emg2])
